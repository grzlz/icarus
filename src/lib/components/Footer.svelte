...
<footer class="bg-gradient-to-b from-primary-900 via-primary-950 to-black text-primary-100 font-primary">
    ...
    <div class="prose">
      ...
      <p class="text-sm leading-relaxed text-primary-300">Estamos construyendo <span class="font-bold text-red-400">Scythe</span>, un protocolo que mejora la coordinación entre la economía y el gobierno de un sistema.</p>
    </div>
        ...
        <div>
            ...
            <form class="flex flex-col sm:flex-row gap-2">
                <input type="email" placeholder="Tu correo electrónico" class="flex-1 px-4 py-2 rounded-lg bg-primary-800/50 border border-primary-700/30 text-primary-100 placeholder-primary-400 text-sm focus:outline-none focus:ring-2 focus:ring-red-400 focus:border-red-400 transition-colors"/>
                <button type="submit" class="bg-red-500 hover:bg-red-400 text-white px-6 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
                    Suscribirme
                </button>
            </form>
        </div>
        ...
        <div>
            ...
            <div class="flex gap-5">
                <a href="https://twitter.com/ScytheManifesto" aria-label="Twitter" class="text-primary-400 hover:text-red-400 transition-colors duration-200 p-2 rounded-lg hover:bg-primary-800/30">
            ...
            <!-- GitHub -->
                <a href="https://github.com/icarus-devs" aria-label="GitHub" class="text-primary-400 hover:text-red-400 transition-colors duration-200 p-2 rounded-lg hover:bg-primary-800/30">
                ...
                <a href="https://www.instagram.com/icarusdev.mx" aria-label="Instagram" class="text-primary-400 hover:text-red-400 transition-colors duration-200 p-2 rounded-lg hover:bg-primary-800/30">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="border-t border-primary-700/40 text-sm text-primary-400 px-6 py-6 relative h-10 overflow-hidden">
        <div class="max-w-6xl mx-auto text-center cursor-pointer relative h-full" onmouseenter={() => hovered = true} onmouseleave={() => hovered = false} role="button" tabindex="0">
            {#if hovered}
            <a href="http://icarus.mx" in:fade={{ duration: 200 }} out:fade={{ duration: 0 }} class="absolute inset-0 flex items-center justify-center hover:text-red-400 transition-colors">
