<script>
	/*
	 * Reusable interactive 3D shirt. Lazy-loads the three.js scene on mount and
	...
	let { phrase, garment = 'black', technique = 'estampado', hint = true } = $props();
...
<div class="relative h-full w-full">
	{#if Shirt3D}
		<Shirt3D {phrase} {garment} {technique} />
	{:else}
